...
export class A2kProgress extends LitElement {
  static styles = css`
    :host {
      --progress-shadow: inset 0 -1px #fff, inset 2px 2px hsl(0deg, 0%, 64%);
      --progress-unit-width: 12px;
      --progress-unit-background: hsl(212deg, 50%, 27%);
      --progress-contents-gap: 4px;
    }
    ...
    #progress {
      ...
      gap: var(--progress-contents-gap, 2px);
      overflow: hidden;
    }
  `;
